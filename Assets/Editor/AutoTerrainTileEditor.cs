...
[CustomEditor(typeof(AutoTerrainTile))]
public class AutoTerrainTileEditor : Editor
{
    private AutoTerrainTile terrainSystem;
    private int selectedRuleIndex = -1;
    
    private void OnEnable()
    {
        terrainSystem = (AutoTerrainTile)target;
    }
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.LabelField("Auto Terrain System", EditorStyles.boldLabel);
    ...
    private void AddNewRule()
    {
        ...
        AutoTerrainTile.TerrainRule newRule = new AutoTerrainTile.TerrainRule();
    ...
    private void ExtractRulesFromPrefabs()
    {
        ...
        // 临时存储提取的规则
        List<AutoTerrainTile.TerrainRule> extractedRules = new List<AutoTerrainTile.TerrainRule>();
